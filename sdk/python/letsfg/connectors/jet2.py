...
class Jet2ConnectorClient:
    ...
    async def _fetch_ancillaries(
        ...
        # Jet2 is unusual among UK leisure airlines: ALL fares include
        # 1 cabin bag (56×45×25 cm, max 10 kg) AND 1 checked bag (22 kg).
        # This is Jet2's primary selling point vs Ryanair/easyJet.
        # Seat selection is a paid add-on starting from £10/sector (standard).
        return {
            "bags_from": 0.0,
            "bags_note": "1 cabin bag (56×45×25 cm, max 10 kg) included",
            "checked_bag_from": 0.0,
            "checked_bag_note": "1 checked bag (22 kg) included",
            "seat_from": 10.0,
            "seat_currency": "GBP",
            "seat_note": "Seat selection from £10/sector (standard); extra legroom from £25/sector — jet2.com",
        }
